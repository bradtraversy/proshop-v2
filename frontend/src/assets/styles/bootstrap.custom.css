...
[data-bs-theme='light'] {
  ...
  --bs-light: #f4f4f4;
  --bs-dark: #7b8a8b;
  --bs-primary-rgb: 60, 76, 93;
  --bs-secondary-rgb: 123, 138, 139;
  ...
  --bs-primary-text: #303d4a;
  --bs-secondary-text: #7b8a8b;
  --bs-success-text: #13967d;
  --bs-info-text: #1f5b83;
  --bs-warning-text: #925e0b;
  --bs-danger-text: #b93d30;
  --bs-light-text: #7b8a8b;
  --bs-dark-text: #7b8a8b;
  --bs-primary-bg-subtle: #d8dbdf;
  ...
  --bs-dark-bg-subtle: #9cabac;
  --bs-primary-border-subtle: #b1b7be;
  --bs-secondary-border-subtle: #bdcecf;
  --bs-success-border-subtle: #a3e4d7;
  --bs-info-border-subtle: #aed6f1;
  --bs-warning-border-subtle: #fad7a0;
  --bs-danger-border-subtle: #f5b7b1;
  --bs-light-border-subtle: #bdcecf;
  --bs-dark-border-subtle: #7b8a8b;
  --bs-white-rgb: 255, 255, 255;
  --bs-black-rgb: 0, 0, 0;
  --bs-body-color-rgb: 123, 138, 139;
  ...
  --bs-body-color: #7b8a8b;
  --bs-emphasis-color: #000;
  --bs-emphasis-color-rgb: 0, 0, 0;
  --bs-secondary-color: rgba(123, 138, 139, 0.75);
  --bs-secondary-color-rgb: 123, 138, 139;
  --bs-secondary-bg: #bdcecf;
  --bs-secondary-bg-rgb: 189, 206, 207;
  --bs-tertiary-color: rgba(123, 138, 139, 0.5);
  --bs-tertiary-color-rgb: 123, 138, 139;
  --bs-tertiary-bg: #f4f4f4;
  --bs-tertiary-bg-rgb: 244, 244, 244;
  --bs-body-bg: #fff;
  --bs-body-bg-rgb: 255, 255, 255;
  --bs-link-color: #3c4c5d;
  --bs-link-color-rgb: 60, 76, 93;
  --bs-link-decoration: underline;
  --bs-link-hover-color: #303d4a;
  --bs-link-hover-color-rgb: 48, 61, 74;
  --bs-code-color: #d63384;
  --bs-highlight-bg: #fdebd0;
  --bs-border-width: 1px;
  --bs-border-style: solid;
  --bs-border-color: #b5c0c1;
...
[data-bs-theme='dark'] {
  ...
  --bs-body-color-rgb: 123, 138, 139;
  --bs-body-bg: #7b8a8b;
  --bs-body-bg-rgb: 123, 138, 139;
  --bs-emphasis-color: #f4f4f4;
  --bs-emphasis-color-rgb: 244, 244, 244;
  --bs-secondary-color: rgba(123, 138, 139, 0.75);
  --bs-secondary-color-rgb: 123, 138, 139;
  --bs-secondary-bg: #7b8a8b;
  --bs-secondary-bg-rgb: 123, 138, 139;
  --bs-tertiary-color: rgba(123, 138, 139, 0.5);
  --bs-tertiary-color-rgb: 123, 138, 139;
  --bs-tertiary-bg: #7b8a8b;
  --bs-tertiary-bg-rgb: 123, 138, 139;
  --bs-emphasis-color: #fff;
  --bs-primary-text: #8a949e;
  --bs-secondary-text: #b5c0c1;
  --bs-success-text: #74d7c4;
  --bs-info-text: #85c1e9;
  --bs-warning-text: #f8c471;
  --bs-danger-text: #f1948a;
  --bs-light-text: #f4f4f4;
  --bs-dark-text: #b5c0c1;
  --bs-primary-bg-subtle: #0c0f13;
  --bs-secondary-bg-subtle: #7b8a8b;
  --bs-success-bg-subtle: #05261f;
  --bs-info-bg-subtle: #0a1e2c;
  --bs-warning-bg-subtle: #311f04;
  --bs-danger-bg-subtle: #2e0f0c;
  --bs-light-bg-subtle: #7b8a8b;
  --bs-dark-bg-subtle: #3e4546;
  --bs-primary-border-subtle: #242e38;
  --bs-secondary-border-subtle: #7b8a8b;
  --bs-success-border-subtle: #0e715e;
  --bs-info-border-subtle: #153d58;
  --bs-warning-border-subtle: #613e07;
  --bs-danger-border-subtle: #8b2e24;
  --bs-light-border-subtle: #7b8a8b;
  --bs-dark-border-subtle: #7b8a8b;
  --bs-heading-color: #fff;
  --bs-link-color: #8a949e;
  --bs-link-hover-color: #b1b7be;
  --bs-link-color-rgb: 138, 148, 158;
  --bs-link-hover-color-rgb: 177, 183, 190;
...
.table-primary {
  --bs-table-color: #000;
  --bs-table-bg: #d8dbdf;
  --bs-table-border-color: #c2c5c9;
  --bs-table-striped-bg: #cdd0d4;
  --bs-table-striped-color: #000;
  --bs-table-active-bg: #c2c5c9;
...
.table-secondary {
  --bs-table-color: #000;
  --bs-table-bg: #e5e8e8;
  --bs-table-border-color: #ced1d1;
  --bs-table-striped-bg: #dadcdc;
  --bs-table-striped-color: #000;
  --bs-table-active-bg: #ced1d1;
  --bs-table-active-color: #000;
  --bs-table-hover-bg: #d4d7d7;
  --bs-table-hover-color: #000;
  color: var(--bs-table-color);
  border-color: var(--bs-table-border-color);
}
...
.table-dark {
  --bs-table-color: #000;
  --bs-table-bg: #7b8a8b;
  --bs-table-border-color: #6f7c7d;
  --bs-table-striped-bg: #758384;
  --bs-table-striped-color: #000;
  --bs-table-active-bg: #6f7c7d;
  --bs-table-active-color: #000;
  --bs-table-hover-bg: #728081;
  --bs-table-hover-color: #000;
  color: var(--bs-table-color);
  border-color: var(--bs-table-border-color);
}
...
.form-control:focus {
  ...
  outline: 0;
  box-shadow: inset 0 1px 2px rgba(var(--bs-body-color-rgb), 0.075),
    0 0 0 0.25rem rgba(60, 76, 93, 0.25);
}
...
.form-select {
  --bs-form-select-bg-img: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 16'%3e%3cpath fill='none' stroke='%237b8a8b' stroke-linecap='round' stroke-linejoin='round' stroke-width='2' d='m2 5 6 6 6-6'/%3e%3c/svg%3e");
  display: block;
  width: 100%;
...
.form-check-input:focus {
  border-color: #9ea6ae;
  outline: 0;
  box-shadow: 0 0 0 0.25rem rgba(60, 76, 93, 0.25);
}
...
.form-switch .form-check-input:focus {
  --bs-form-switch-bg: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='-4 -4 8 8'%3e%3ccircle r='3' fill='%239ea6ae'/%3e%3c/svg%3e");
}
...
.form-range:focus::-webkit-slider-thumb {
  box-shadow: 0 0 0 1px #fff, 0 0 0 0.25rem rgba(60, 76, 93, 0.25);
}
...
.form-floating::before:not(.form-control:disabled) {
  ...
  width: calc(
    100% - (calc(calc(0.375em + 0.3375rem) + calc(0.75em + 0.675rem)))
  );
  height: 1.875em;
  content: '';
  background-color: var(--bs-form-control-bg);
...
.btn-primary {
  --bs-btn-color: #fff;
  --bs-btn-bg: #3c4c5d;
  --bs-btn-border-color: #3c4c5d;
  --bs-btn-hover-color: #fff;
  --bs-btn-hover-bg: #33414f;
  --bs-btn-hover-border-color: #303d4a;
  --bs-btn-focus-shadow-rgb: 89, 103, 117;
  --bs-btn-active-color: #fff;
  --bs-btn-active-bg: #303d4a;
  --bs-btn-active-border-color: #2d3946;
  --bs-btn-active-shadow: inset 0 3px 5px rgba(0, 0, 0, 0.125);
  --bs-btn-disabled-color: #fff;
  --bs-btn-disabled-bg: #3c4c5d;
  --bs-btn-disabled-border-color: #3c4c5d;
}
...
.btn-secondary {
  ...
  --bs-btn-focus-shadow-rgb: 105, 117, 118;
...
.btn-success {
  ...
  --bs-btn-hover-color: #000;
  --bs-btn-hover-bg: #3bc6ab;
  --bs-btn-hover-border-color: #2fc3a6;
  --bs-btn-focus-shadow-rgb: 20, 160, 133;
  --bs-btn-active-color: #000;
  --bs-btn-active-bg: #46c9b0;
  --bs-btn-active-border-color: #2fc3a6;
  --bs-btn-active-shadow: inset 0 3px 5px rgba(0, 0, 0, 0.125);
  --bs-btn-disabled-color: #000;
...
.btn-outline-primary {
  ...
  --bs-btn-border-color: #3c4c5d;
  --bs-btn-hover-color: #fff;
  --bs-btn-hover-bg: #3c4c5d;
  --bs-btn-hover-border-color: #3c4c5d;
  --bs-btn-focus-shadow-rgb: 60, 76, 93;
  --bs-btn-active-color: #fff;
  --bs-btn-active-bg: #3c4c5d;
  --bs-btn-active-border-color: #3c4c5d;
  --bs-btn-active-shadow: inset 0 3px 5px rgba(0, 0, 0, 0.125);
  --bs-btn-disabled-color: #3c4c5d;
...
.dropdown-menu {
  ...
  --bs-dropdown-link-active-bg: #3c4c5d;
  --bs-dropdown-link-disabled-color: #7b8a8b;
  --bs-dropdown-item-padding-x: 1.2rem;
  --bs-dropdown-item-padding-y: 0.3rem;
  --bs-dropdown-header-color: #7b8a8b;
...
.dropdown-menu-dark {
  --bs-dropdown-color: #b5c0c1;
  --bs-dropdown-bg: #7b8a8b;
  --bs-dropdown-border-color: var(--bs-border-color-translucent);
  --bs-dropdown-box-shadow: ;
  --bs-dropdown-link-color: #b5c0c1;
...
.nav-pills {
  ...
  --bs-nav-pills-link-active-bg: #3c4c5d;
}
.nav-pills .nav-link {
  background: none;
  border: 0;
...
.navbar {
  ...
  --bs-navbar-toggler-icon-bg: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 30 30'%3e%3cpath stroke='rgba%28123, 138, 139, 0.75%29' stroke-linecap='round' stroke-miterlimit='10' stroke-width='2' d='M4 7h22M4 15h22M4 23h22'/%3e%3c/svg%3e");
...
.accordion {
  ...
  --bs-accordion-btn-icon: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 16' fill='%237b8a8b'%3e%3cpath fill-rule='evenodd' d='M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708z'/%3e%3c/svg%3e");
  --bs-accordion-btn-icon-width: 1.25rem;
  --bs-accordion-btn-icon-transform: rotate(-180deg);
  --bs-accordion-btn-icon-transition: transform 0.2s ease-in-out;
  --bs-accordion-btn-active-icon: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 16' fill='%23303d4a'%3e%3cpath fill-rule='evenodd' d='M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708z'/%3e%3c/svg%3e");
  --bs-accordion-btn-focus-border-color: #9ea6ae;
  --bs-accordion-btn-focus-box-shadow: 0 0 0 0.25rem rgba(60, 76, 93, 0.25);
...
[data-bs-theme='dark'] .accordion-button::after {
  --bs-accordion-btn-icon: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 16' fill='%238a949e'%3e%3cpath fill-rule='evenodd' d='M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708z'/%3e%3c/svg%3e");
  --bs-accordion-btn-active-icon: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 16' fill='%238a949e'%3e%3cpath fill-rule='evenodd' d='M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708z'/%3e%3c/svg%3e");
}
...
.pagination {
  ...
  --bs-pagination-focus-box-shadow: 0 0 0 0.25rem rgba(60, 76, 93, 0.25);
  --bs-pagination-active-color: #fff;
  --bs-pagination-active-bg: #3c4c5d;
  --bs-pagination-active-border-color: #3c4c5d;
...
.list-group {
  ...
  --bs-list-group-active-bg: #3c4c5d;
  --bs-list-group-active-border-color: #3c4c5d;
  display: flex;
  flex-direction: column;
  padding-left: 0;
  margin-bottom: 0;
...
.btn-close {
  ...
  --bs-btn-close-focus-shadow: 0 0 0 0.25rem rgba(60, 76, 93, 0.25);
...
.text-bg-primary {
  color: #fff !important;
  background-color: RGBA(60, 76, 93, var(--bs-bg-opacity, 1)) !important;
}

.text-bg-secondary {
  color: #000 !important;
  background-color: RGBA(123, 138, 139, var(--bs-bg-opacity, 1)) !important;
}

.text-bg-success {
  color: #000 !important;
  background-color: RGBA(24, 188, 156, var(--bs-bg-opacity, 1)) !important;
}
